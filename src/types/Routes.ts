...
export type Middleware = (request: ParsedRequest, response: CraftedResponse, context: Context) => any | void | boolean | Promise<any | void | boolean>;

export interface RouteDefinition {
  route: Route<{ [i: string]: any }>;
  method: Method;
  handler: (request: ParsedRequest<any>, response: CraftedResponse, context: Context) => void | Promise<void>;
  args?: any[];
